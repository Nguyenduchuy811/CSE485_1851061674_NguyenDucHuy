<section> 
    ...
    <form>
        ...
        <div class="form-group">
          ...
          <input type="text"
            class="form-control" name="member_cv_id" id="member_cv_id" aria-describedby="helpId" placeholder="1" value="<?php echo $experience[0]['member_cv_id'] ?>" disabled>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" name="content" id="content" rows="10" placeholder="trường đại học Thủy Lợi" disabled><?php echo $experience[0]['content'] ?></textarea>
        </div>
